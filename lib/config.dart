...
const DICT_URL="http://10.0.2.2:4000/offline/dictionary";
...
const BASE_URL="https://9q81vs2n0e.execute-api.ap-southeast-1.amazonaws.com/dev";

const TOPIC_URL= BASE_URL+"/offline/topic/all";

const EXERCISECOUNT_URL= BASE_URL+"/offline/topicLevelCount/all";