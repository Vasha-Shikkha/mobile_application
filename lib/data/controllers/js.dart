...
class JSController{
  ...
  Future<List<JS>> getJSList(String token,int topicId,int level,int limit,int offset) async{
    ...
    List<JS>result = await jsDatabaseHelper.getJSList(topicId, level,limit:limit,offset:offset);
    return result;
