...
class FBController{
  ...
  Future<List<FB>> getFBList(String token,int topicId,int level,int limit,int offset) async{
    ...
    int count= await taskDatabaseHelper.getCount("Fill in the Blanks", topicId);
    ...
    List<FB>result = await fbDatabaseHelper.getFBList(topicId, level,limit:limit,offset:offset);
    return result;
