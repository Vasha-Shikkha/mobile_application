...
class MCQController{
  ...
  Future<List<MCQ>> getMCQList(String token,int topicId,int level,int limit,int offset) async{
    ...
    List<MCQ>result = await mcqDatabaseHelper.getMCQList(topicId, level,limit:limit,offset:offset);
    return result;
